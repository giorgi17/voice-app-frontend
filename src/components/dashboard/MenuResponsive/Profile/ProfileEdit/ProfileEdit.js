...
class ProfileEdit extends Component {
    ...
    render() {
        ...
        return (
            <div className="responsive-profile-edit-container">
                <div id="responsive-profile-edit-go-back-container" onClick={() => this.props.changeDisplayedContent(<ProfileView changeDisplayedContent={this.props.changeDisplayedContent} ></ProfileView>)}>
                    <span className="material-icons responsive-profile-edit-go-back-icon">
                        arrow_back_ios
                    </span>
                </div>

                <div id="responsive-profile-edit-picture-cropper-container" ref={this.cropperDisplayRef}>
                    ...
                    className="responsive-profile-edit-activity-info-inputs" color="primary">Update picture</Button> */}
                </div>

                <div className="responsive-profile-edit-image-wrapper" onClick={this.changeImageCropperDisplay}>
                    <span className="material-icons responsive-profile-edit-edit-image-icon">
                        edit
                    </span>
                    <img src={this.state.userData.avatarImage} />
                </div>
             
                <div className="responsive-profile-edit-activity-info-wrapper">
                    <TextField id="profile-edit-activity-info-name" required name="name"
                    className="responsive-profile-edit-activity-info-inputs" type="text" helperText={errors.name}
                    ...
                    className="responsive-profile-edit-activity-info-inputs" type="email"
                    ...
                    className="responsive-profile-edit-activity-info-inputs" color="primary">Change password</Button>

                    <div id="responsive-profile-edit-activity-info-change-password-wrapper" ref={this.changePasswordRef} >
                        ...
                        className="responsive-profile-edit-activity-info-inputs" type="password" onChange={this.onChange}
                        label="Current password" />
                        <span className="material-icons responsive-profile-edit-activity-info-password-visibility-icon" onClick={() => this.makePasswordVisible(1)}>
                        ...
                        className="responsive-profile-edit-activity-info-inputs" type="password" onChange={this.onChange}
                        label="New password" />
                        <span className="material-icons responsive-profile-edit-activity-info-password-visibility-icon" onClick={() => this.makePasswordVisible(2)}>
                        ...
                        <span className="material-icons responsive-profile-edit-activity-info-password-visibility-icon" onClick={() => this.makePasswordVisible(3)}>
                            {this.state.visibility3}
                        </span>

                        <Button variant="contained" type="submit" id="responsive-profile-edit-activity-info-change-password-submit" onClick={this.onChangePasswordSubmit}
                        className="responsive-profile-edit-activity-info-inputs" color="primary">Update password</Button>
                    </div>

                    <Alert severity="success" id="responsive-profile-edit-activity-info-success" className="responsive-profile-edit-activity-info-alert" ref={this.profileInfoUpdateSuccessRef}>
                        <AlertTitle>Success</AlertTitle>
                        Successfully changed user information.
                    </Alert>

                    <Alert severity="error" id="responsive-profile-edit-activity-info-error" className="responsive-profile-edit-activity-info-alert" ref={this.profileInfoUpdateErrorRef}>
                    ...
                    className="responsive-profile-edit-activity-info-inputs" color="primary">Update</Button>
