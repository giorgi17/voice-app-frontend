        ...
        return (
            <div className="responsive-recordvoice-view-container" ref={this.mainContainerRef}>
                ...
                <div id="add-post-container" ref={this.addNewPostContainerRef}>
                    <div id="responsive-recordvoice-view-post-button" onClick={this.addNewPostHandler}>
                        <span id="responsive-recordvoice-view-post-button-label">Post</span>
                        <span className="material-icons responsive-recordvoice-view-post-button-label-icon">
                            forward
                        </span>
                    </div>
                    <h3>Record</h3>
