            ...
            <div className="recordvoice-view-container">
                ...
                <div id="add-post-container" ref={this.addNewPostContainerRef}>
                    ...
                    <div id="recordvoice-view-post-picture-and-record-container">
                        ...
                        <div ref={this.recordButtonRef} id="recordvoice-view-record-button" onClick={() => startRecording(this.state, this.changeFileName, this.deviceNotFound, this.deviceFound, this.changeRecording, this.changeRecordButtonText, this.changeAudioBlob)}>{this.state.recordButtonText}</div>
                    </div>
