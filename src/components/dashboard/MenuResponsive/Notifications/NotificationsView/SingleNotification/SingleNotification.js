...
class SingleNotification extends Component {
    ...
    render() {
        return (
                <React.Fragment>
                    <div 
                        className={`responsive-single-notification ${this.props.seen ? "" : "responsive-unseen-notification"}`}
                        ref={this.singleNotificationRef}>

                        <div className="responsive-single-notification-image-wrapper">
                            <img src={this.state.profilePicture}></img>
                        </div>
                        <div className="responsive-single-notification-text">
                            <p dangerouslySetInnerHTML={this.createTextMarkup()}>
                            </p>

                            <div className="responsive-single-notification-date-wrapper">
                                {this.state.date}
                            </div>
                        </div>
                        <div className="responsive-single-notification-right-image-wrapper" ref={this.notificationImageRef}>
                            <img className="responsive-single-notification-image" 
                            src={this.state.postPicture} />
                        </div>
                        
                    </div>
                    <hr className="responsive-single-notification-hr"></hr>
                </React.Fragment>
            );  
    }
};
